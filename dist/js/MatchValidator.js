...
function (_Validator) {
  ...
  function MatchValidator(selector, otherSelector) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(MatchValidator).call(this, selector)); // call constructor in Validator()

    console.log('constructor from MatchValidator');
    _this.$otherField = document.querySelector(otherSelector);
    return _this;
  }
  ...
  _createClass(MatchValidator, [{
    ...
    value: function validate() {
      _get(_getPrototypeOf(MatchValidator.prototype), "validate", this).call(this);
